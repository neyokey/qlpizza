    ...
    <div class="col-sm-8 text-center"> 
      	<div class="tieude"> Thông tin tài khoản </div>
      		<div class="personal-details">
				...
				<div class="owner-name">Tên người dùng</div>
				<br>
				<div>Mã số thẻ: <?php echo $data['0']['MaNguoidung'] ?></div>
				<div>Điểm thưởng: <?php echo $data['0']['Diem'] ?></div>
				<div>Loại thành viên: 
					<?php if($data['0']['MaLoaiNguoidung'] == "nm") 
